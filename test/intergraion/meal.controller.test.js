...
const meal1 = `INSERT INTO meal (id, name, description, price, maxAmountOfParticipants, isActive, isVega, isVegan, isToTakeHome, imageUrl, cookId, allergenes) VALUES (15, 'test', 'test', 5, 5, 1, 0, 0, 1, 'test', 44, 'test')`;
